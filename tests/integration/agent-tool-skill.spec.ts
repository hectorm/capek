...
test.describe("Agent Tool Skill", () => {
  test("should execute skill via tool call", async ({ page }) => {
    ...
    const agentOption = page.getByRole("option", { name: /Mock specialist tool agent/i });
